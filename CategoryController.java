...
{  
        ...
        public String showCategory(Model m)
        {
        	...
        	m.addAttribute("Pagename", "Category");
        	return "Category";
        ...
        m.addAttribute("categoryList" ,categoryList);
        	...
        	m.addAttribute("Pagename", "Insert Category");
        	return "Category";
        }
        ...
        public String editCategory(@PathVariable("categoryId")int categoryId,Model m)
        {
        	...
        	m.addAttribute("Pagename", "Update Category");
        ...
        {
        	System.out.println("Iam in update Category");
          Category category=new Category();
          category.setCategoryId(categoryId);
          category.setCategoryName(categoryName);
          category.setCategoryDesc(categoryDesc);
        ...
        public String deleteCategory(@PathVariable("categoryId")int categoryId,Model m)
        {
        	...
        	List<Category> categoryList=categoryDAO.retrieveCategories();
            m.addAttribute("categoryList" ,categoryList);
            m.addAttribute("Pagename", "Delete Category");
              return "Category";
        }
